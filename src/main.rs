...
fn main() -> Result<(), ImageDataErrors> {
    let args = Args::new();
    let (image_1, image_format_1) = find_image_by_path(args.image_1)?;
    let (image_2, image_format_2) = find_image_by_path(args.image_2)?;
...
fn find_image_by_path(path: String) -> Result<(DynamicImage, ImageFormat), ImageDataErrors> {
